...
component('angularFilemanager', {
  restrict: 'EA',
  template: `<div ng-include="config.tplPath + '/navbar.html'"></div>
...
<div ng-include="config.tplPath + '/item-context-menu.html'"></div>`,
  ...
  controller: ['$scope', '$rootScope', '$window', '$translate', 'fileManagerConfig', 'item', 'fileNavigator', 'apiMiddleware',
    function FileManagerCtrl($scope, $rootScope, $window, $translate, fileManagerConfig, Item, FileNavigator, ApiMiddleware) {
      FileManagerCtrlFunction($scope, $rootScope, $window, $translate, fileManagerConfig, Item, FileNavigator, ApiMiddleware);
    }
  ]
});


function FileManagerCtrlFunction($scope, $rootScope, $window, $translate, fileManagerConfig, Item, FileNavigator, ApiMiddleware) {
